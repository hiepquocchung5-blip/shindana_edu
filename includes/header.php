...
<head>
    ...
    <style>
        :root {
            /* Extracted strictly from the provided SHN Logo */
            --brand-gold: #E5B822; 
            --brand-red: #D92128;
            --slate-900: #0f172a;
        }
    ...
    <header class="fixed w-full z-50 transition-all duration-300 flex flex-col"
        ...
        <div class="bg-slate-900 text-white/80 py-1.5 px-4 sm:px-6 lg:px-12 text-[9px] md:text-[10px] font-bold uppercase tracking-widest hidden md:flex justify-between items-center z-50 relative transition-all duration-300"
            ...
            <div class="flex gap-4 items-center">
                ...
                <a href="#" class="hover:text-[--brand-gold] transition flex items-center gap-1.5">
                    <i class="fa-regular fa-newspaper opacity-70"></i> News & Events
                </a>
            </div>
        </div>
                ...
                <div class="hidden lg:flex items-center gap-6 xl:gap-8 h-full">
                    ...
                    <div class="relative py-4 dropdown-wrapper cursor-pointer h-full flex items-center">
                        <span class="text-xs font-bold uppercase tracking-widest text-slate-600 hover:text-[--brand-red] transition flex items-center gap-1.5">
                            <i class="fa-solid fa-graduation-cap text-slate-300 opacity-70"></i> Programs <i class="fa-solid fa-chevron-down text-[9px] opacity-50 ml-0.5"></i>
                        </span>
                        ...
                        <div class="dropdown-menu absolute top-[100%] left-1/2 -translate-x-1/2 w-[400px] bg-white rounded-2xl shadow-2xl border border-slate-100 p-4 grid grid-cols-2 gap-2">
                            ...
                            <a href="<?= base_url('index.php?route=pages/landing#programs') ?>" class="p-3 rounded-xl hover:bg-slate-50 group/item transition col-span-2 mt-2 bg-slate-900 text-white flex justify-between items-center shadow-md">
                                <div>
                    ...
                    <a href="<?= base_url('index.php?route=pages/landing#branches') ?>" class="text-xs font-bold uppercase tracking-widest text-slate-600 hover:text-[--brand-red] transition flex items-center gap-1.5 group">
                        <i class="fa-solid fa-map-location-dot text-slate-300 group-hover:text-[--brand-red] transition-colors"></i> Network
                    </a>
                    
                    <a href="<?= route('pages/schools') ?>" class="text-xs font-bold uppercase tracking-widest text-slate-600 hover:text-[--brand-red] transition flex items-center gap-1.5 group">
                        <i class="fa-solid fa-database text-slate-300 group-hover:text-[--brand-red] transition-colors"></i> Pacific DB
                    </a>
                </div>
