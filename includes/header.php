...
<head>
    ...
    <title><?= h(APP_NAME ?? 'Sheindana') ?> | <?= h(APP_TAGLINE ?? 'Global Education Ecosystem') ?></title>
    ...
    <header class="fixed w-full z-50 transition-all duration-300 flex flex-col"
        ...
        <div class="bg-slate-900 text-white/80 py-1.5 px-4 sm:px-6 lg:px-12 text-[9px] md:text-[10px] font-bold uppercase tracking-widest hidden md:flex justify-between items-center z-50 relative transition-all duration-300"
            ...
            <div class="flex gap-4">
                <a href="<?= route('pages/about') ?>" class="hover:text-[--brand-gold] transition">Company Profile</a>
        ...
        <nav class="border-b border-slate-100 w-full z-40 relative transition-all duration-300"
            ...
            <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 flex justify-between items-center">
                ...
                <a href="<?= base_url() ?>" class="flex items-center gap-3 group z-50">
                    <div class="w-10 h-10 md:w-11 md:h-11 rounded-full bg-[--brand-gold] flex items-center justify-center shadow-lg group-hover:-rotate-12 transition-transform relative overflow-hidden border-2 border-white shrink-0">
                    ...
                    <div class="leading-tight">
                        <span class="block font-black uppercase text-slate-900 tracking-tight text-base md:text-lg group-hover:text-[--brand-red] transition-colors">
                            Sheindana<span class="text-[--brand-gold]">.edu</span>
                        </span>
                        <span class="hidden md:block text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                ...
                <div class="hidden lg:flex items-center gap-6 xl:gap-8 h-full">
                    <a href="<?= base_url('index.php?route=pages/landing#about') ?>" class="text-xs font-bold uppercase tracking-widest text-slate-600 hover:text-[--brand-red] transition">About Us</a>
                ...
                <div class="flex flex-col px-4 sm:px-6 py-6 space-y-5">
                    ...
                    <div class="space-y-2">
                        <a href="<?= base_url('index.php?route=pages/landing#about') ?>" @click="mobileMenuOpen = false" class="flex justify-between items-center text-base sm:text-lg font-black uppercase tracking-widest text-slate-900 border border-slate-100 bg-white p-4 rounded-2xl hover:border-[--brand-gold] transition active:scale-[0.98]">
            ...
            <div x-show="mobileMenuOpen" x-cloak 
                 ...
                 class="absolute top-full left-0 w-full bg-white border-b border-slate-100 shadow-2xl lg:hidden h-screen overflow-y-auto">
                <div class="flex flex-col px-6 py-8 space-y-6">
                    <a href="<?= route('pages/about') ?>" @click="mobileMenuOpen = false" class="flex justify-between items-center text-lg font-black uppercase tracking-widest text-slate-900 border-b border-slate-50 pb-4">
                        <span>About Us / Profile</span> <i class="fa-solid fa-chevron-right text-[--brand-gold] text-sm"></i>
                    </a>
