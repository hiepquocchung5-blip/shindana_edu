...
// 2. Fetch Dashboard Stats (Removed Enquiries/Leads)
try {
    $stats = [
    ...
    $stats = ['agents'=>0, 'students'=>0, 'classes'=>0, 'pending_apps'=>0];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-slate-50 text-slate-900">
    ...
    <main class="max-w-7xl mx-auto p-6 md:p-12">
        ...
        <!-- Stats Grid (Rebalanced to 3 columns since Enquiries is removed) -->
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Module 1: Branch Network (Fixed 5) -->
            <a href="<?= admin_url('branches') ?>" class="group bg-white p-8 rounded-[32px] shadow-lg border border-slate-100 hover:border-[#D4AF37] transition duration-300 relative overflow-hidden">
